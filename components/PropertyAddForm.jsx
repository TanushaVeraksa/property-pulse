...
const PropertyAddForm = () => {
  ...
  const handleAmenitiesChange = (e) => {
    ...
    const updatedAminites = [...fields.amenities];

    if (checked) {
      // Add value to array
      updatedAminites.push(value);
    } else {
      // Remove value from array
      const index = updatedAminites.indexOf(value);
      if (index !== -1) {
        updatedAminites.splice(index, 1);
      }
    }
    // Update state with updated array
    setFields((prevFields) => ({
      ...prevFields,
      amenities: updatedAminites,
    }));
  };
          ...
          <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
            <div className="flex items-center">
              ...
              <input
                ...
                id="weekly_rate"
                name="rates.weekly"
                className="border bg-white border-gray-200 rounded w-full py-2 px-3"
